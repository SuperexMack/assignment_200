...
export default function ChatBox() {
  ...
  const sendData = async () => {
    setLoading(true)
    await axios.post("http://localhost:8000/getdata", {
      userdaata: userData
    })
    .then((response) => {
  ...
  return (
    <div>
      {loading === true ? (
        ...
        <>
          <div className="h-[600px] w-[80%] mx-auto mt-8 bg-white rounded-xl shadow-xl overflow-hidden">
            <div className="h-[60px] bg-gradient-to-r from-blue-600 to-indigo-800 flex items-center px-6">
              <h2 className="text-white text-xl font-bold">CrustData API Assistant</h2>
            </div>
            ...
            <div className="h-[80px] bg-white border-t border-gray-200 p-4">
